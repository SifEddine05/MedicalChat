...
const Landing = () => {
    ...
    <div className="h-screen overflow-hidden bg-blue-100">
        ...
        <div className='w-[90%] mx-auto flex flex-col md:flex-row justify-around items-center '>
            ...
            <div className='md:w-[50%] w-[100%]  md:rounded-full '> 
                <img src={bg} alt='chat' className='md:rounded-full  md:w-full md:max-h-screen  max-h-[480px] w-full'/>
            </div>
        </div>
    </div> );
}
